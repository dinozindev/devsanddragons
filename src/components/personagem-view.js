...
// classe responsável por renderizar as instâncias presentes dentro do array personagens no HTML.
export class PersonagemView {
    ...
    // function responsável por renderizar as instâncias no HTML. 
    render() {
